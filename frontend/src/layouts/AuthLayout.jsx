  ...
  <div className="min-h-screen bg-gradient-to-br from-slate-100 via-white to-orange-50 p-6 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900">
    <div className="mx-auto flex max-w-5xl flex-col gap-8">
      <header className="flex items-center justify-between">
        ...
        <span className="rounded-full border border-accent-500/40 px-3 py-1 text-xs uppercase tracking-widest text-accent-600">
          Invite Only
        </span>
      </header>
      <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-3xl bg-white/80 p-8 shadow-soft dark:bg-slate-900/80">
          {children}
        </div>
        <div className="flex flex-col justify-between rounded-3xl bg-slate-900 p-8 text-white shadow-soft">
          <div>
